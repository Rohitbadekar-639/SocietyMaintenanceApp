...
const LOGO_SRC = '/images/societywale-logo.png'
...
/**
 * Official SocietyWale wordmark. On dark surfaces use light=true so the black logo plate stays readable.
 */
